    ...
    try:
        ...
        if (not token):
            ...
            project_type = click.prompt(
                "Project type: [app/module/toolkit/model]")
...
def create_job():
    try:
        ...
        if (not token):
            ...
            arg = click.prompt(
                "Extra argument[Optional]", show_default=False, default="")
            args = ""
            while (arg):
            ...
            job_file = click.prompt(
                "Job file[Optional]", show_default=False, default="")
            while (job_file):
